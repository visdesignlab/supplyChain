...
//Function that transforms addresses into lat/lon
export function geocodeAddress(geocoder, resultsMap) {
  geocoder.geocode({'address': '219 North 530 West, Ogden, UT'}, function(results, status) {
    if (status === 'OK') {
